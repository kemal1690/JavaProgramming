...
public class SetExamples {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("stringSet = " + linkedHashSet);//stringSet = [z, o, x, a, b, c, d, e]
        linkedHashSet.add(null);
        System.out.println("stringSet after adding null = " + linkedHashSet);//stringSet after adding null = [z, o, x, a, b, c, d, e, null]
        ...
        System.out.println("stringSet1 = " + hashSet);//stringSet1 = [a, b, c, d, e, x, z, o]
        hashSet.add("g");
        hashSet.add("null");
        System.out.println("stringSet1 = " + hashSet);//stringSet1 = [a, b, c, d, null, e, g, x, z, o]
        ...
        System.out.println("stringSet2 = " + treeSet);//[a, b, c, d, e, o, x, z]
