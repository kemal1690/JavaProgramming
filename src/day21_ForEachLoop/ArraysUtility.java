...
public class ArraysUtility {
    public static void main(String[] args) {
        ...
        /*
        String str = "Java";
        System.out.println(str); String class complier use toString() method implicitly
        ...
        System.out.println(Arrays.toString(words)); //[ANNA, Anna] ANNA has lowest number accordint to ascii table
                                                    // lowercase starts from a-z 97, uppercase starts from A-Z 65
        ...
        String word1 = "acb";
        String word2 = "abc";
        //Compare them whether they are anagram or not
        char[] ch1 = {'a','c','b'};
        char[] ch2 = {'a', 'b', 'c'};
