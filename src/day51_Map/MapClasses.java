...
public class MapClasses {
    ...
    public static void main(String[] args) {
        ...
        //values can be duplicated
          //key ,   value
        //for all the non-primitives default value is null
        ...
        hashMap.put(3,"Jack");
        hashMap.put(40,"Emma");
        hashMap.put(5,"Ahmet");//this will be removed because when the duplication occurs, it puts the last key and value
        hashMap.put(5,"Isabella");
        hashMap.put(6,null); //values can be duplicated
        hashMap.put(7,null);
        hashMap.put(8,null);
        hashMap.put(null,null);
        hashMap.put(null,"Emre");
        hashMap.put(null,"Hulya");//keys are not duplicated thats why it puts null, Hulya the last one
