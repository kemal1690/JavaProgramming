...
public class RelationalOperators {
    ...
    boolean result2 = 300 >= 150; //true
        ...
        int creditScore = 745;
        boolean isEligibleForLoan = creditScore >= 720;// if the creditScore 720 or greater, it is eligible for loan
        ...
        boolean result101 = "  Java" == "Java";//false
        System.out.println("result11 = " + result101);
