...
public class UniaryOperators {
    ...
    int num2 = -25;
        ...
        System.out.println(a);//5 ==> current value is 6 because we increased it by ++a
        ...
        int x = 200;
        System.out.println(--x); //pre decrement: decreases the value by 1

        int y = 200;
        System.out.println (y--);// post decrement first pass the current value then decreases the value by 1
