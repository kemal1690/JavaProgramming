...
public class ArraysUtility {
    ...
    public static int[] addElement(int[] array, int element) {
        ...
        result[i] = element;//we are assigning the element to the last index of the array
    ...
    public static int[] uniqueElement(int[] array) {
        ...
        for (int each : array) {
            if (ArraysUtility.frequencyOfElement(array, each) == 1) {//if frequency = 1, the each element is unique

                result = ArraysUtility.addElement(result, each);
                // We add each unique element to the result array
            }
        }
        return result;
    }
    ...
    public static int[] replace(int[] array, int index, int newElement){
        ...
        array[index] = newElement;//new element will replace the given index of the array
    ...
    public static int[] replaceAll(int[] array, int oldValue, int newValue) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (array[i] == oldValue) { //we check the index which matches the oldValue thats why we created if condition
                array[i] = newValue;
            }
