...
public class MyScrumTeam {
    public static void main(String[] args) {
        ...
        Tester[] testers = {tester2,tester3,tester4};//We didnt write tester1 because we added it to scrum below
        ...
        Developer[] developers = {developer2,developer3,developer4};//We didnt write tester1 because we added it to scrum below

        // 1 ScrumTeam Object
        ScrumTeam scrum = new ScrumTeam("Nigara", "Huseyin", "Neira", 14);

        scrum.addTester(tester1);//We have addTester method in ScrumTeam class
       ...
       for( Tester eachTester: scrum.testersList){//we created testersList in ScrumTeam Class
