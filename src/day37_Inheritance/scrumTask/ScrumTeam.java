...
public ArrayList<Tester> testers = new ArrayList<>();//We can initialize ArrayList in the constructor or here
public ArrayList<Developer> developers = new ArrayList<>();//We can initialize ArrayList in the constructor or here
    ...
    public void addTesters(Tester[] testers){//Tester[] testers : local variable has the same name
        // with the instance variable, thats why we use this key word

        this.testers.addAll(Arrays.asList(testers));//convert array to the non-primitive collection type
    }
