...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        MyFirstFunctionalInterface oddOrEvenNumber = (n) -> {//instead of n we can give any name
        ...
        oddOrEvenNumber.apply(20);//apply method comes from  MyFirstFunctionalInterface
