...
public class NestedMap {
    ...
    public static void main(String[] args) {
        ...
        mapOfMap.put(map1,map2);//map1 is key of mapOfMap, map2 is value of mapOfMap
        ...
        for (Map.Entry<Map<Integer, String>, Map<String, Integer>> mapMapEntry : mapOfMap.entrySet()) {
            ...
            for(Map.Entry<Integer,String> entry : mapMapEntry.getKey().entrySet()){
                //We should write getKey in the right because first map is our key of mapOfMap

                System.out.println(entry.getValue());//We get the jobTitles(values) of first Map(key of mapOfMap)

            }

            for(Map.Entry<String,Integer> entry: mapMapEntry.getValue().entrySet()){

                System.out.println(entry.getKey());//We get the value of MapOfMap end names (key) of map2
            }
        ...
        System.out.println(mapOfMap.get(map1));//gives the map2.Because get(map1) gives the value of mapOfMap
