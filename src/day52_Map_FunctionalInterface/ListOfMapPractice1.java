...
public class ListOfMapPractice1 {
    ...
    public static void main(String[] args) {
       ...
       // scrumTeams.add((LinkedHashMap) scrumTeam1);
        ...
        List<Map<String,String>> scrumTeams = new ArrayList<>();//List should support Map objects
        scrumTeams.add(scrumTeam1);//We are adding the map into List of Map
        ...
        for(Map<String, String> eachScrumTeam  :  scrumTeams){//We are getting each of the Map
            for (Map.Entry<String, String> entry : eachScrumTeam.entrySet()) {//entry represents the key and value
