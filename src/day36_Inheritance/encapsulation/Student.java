...
public class Student {
    ...
    public Student(String name, int age, char gender, char grade, String schoolName) {
        //setter also checks the condition, requirements, if data doesnt meet the condition or requirement it is not set by setter
        setName(name);
        setAge(age);
        setGender(gender);
        setGrade(grade);
    ...
    public void setName(String name){//if return type is not void it must return a value
        this.name = name;
    }
